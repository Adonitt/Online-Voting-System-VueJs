  ...
  >
    <div class="container-fluid">
      ...
      <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
        ...
        <li class="nav-item topbar-user dropdown hidden-caret" :class="{'show': props.isUserMenuOpen}">
          <a
          ...
          <ul class="dropdown-menu dropdown-user animated fadeIn" :class="{'show': props.isUserMenuOpen}">
